...
export default class RelojLCDPreferences extends ExtensionPreferences {
    fillPreferencesWindow(window) {
        ...
        const displayGroup = new Adw.PreferencesGroup({
            ...
            description: 'Customize the clock display and colors'
        });
        page.add(displayGroup);

        const widgetRow = new Adw.ActionRow({
            title: 'Desktop Widget Mode',
            subtitle: 'Show clock on desktop instead of the top bar'
        });
        ...
        const secondsRow = new Adw.ActionRow({
            title: 'Show Seconds',
            subtitle: 'Display seconds in the time display'
        });
        ...
        const dateRow = new Adw.ActionRow({
            title: 'Show Date',
            subtitle: 'Display current date below the time'
        });
        ...
        const blinkRow = new Adw.ActionRow({
            title: 'Blinking Separators',
            subtitle: 'Make the time separators blink for classic LCD effect'
        });
        ...
        const flickerRow = new Adw.ActionRow({
            ...
            subtitle: 'Add subtle random flicker for vintage LCD display feel'
        });
        ...
        const fontRow = new Adw.ActionRow({
            title: 'Font Size',
            subtitle: 'Adjust the clock display size'
        });
        ...
        const fontStyleRow = new Adw.ComboRow({
            title: 'Font Style',
            subtitle: 'Choose the font style (synthetic bold/italic by Pango)',
            model: new Gtk.StringList({ strings: ['Regular', 'Italic', 'Bold', 'Italic Bold'] }),
        ...
        const previewRow = new Adw.PreferencesGroup({ description: 'Live preview' });
        previewRow.add(previewOverlay);
        displayGroup.add(previewRow);

        const colorRow = new Adw.ComboRow({
            title: 'Color Theme',
            subtitle: 'Choose your preferred LCD color style',
            model: new Gtk.StringList({ strings: ['Neon Green', 'Vintage Amber', 'Retro LCD', 'Red Ruby', 'Blue Sapphire', 'White LED', 'Violet Purple', 'Gold', 'Custom Color'] }),
        ...
        const customColorRow = new Adw.ActionRow({
            title: 'Custom Color',
            subtitle: 'Applies to digits, separators, alarm dot and border'
        });
        ...
        const glowRow = new Adw.ActionRow({
            title: 'Glow / Shadow Intensity',
            subtitle: 'Control glow for colored themes or shadow strength for Retro LCD'
        });
        ...
        const positionRow = new Adw.ComboRow({
            ...
            subtitle: 'Choose where the clock appears on the panel',
        ...
        const alarmGroup = new Adw.PreferencesGroup({
            ...
            description: 'Configure alarm time and notification settings'
        });
        page.add(alarmGroup);

        const alarmEnabledRow = new Adw.ActionRow({
            title: 'Enable Alarm',
            subtitle: 'Turn on the alarm functionality'
        });
        ...
        const alarmTimeRow = new Adw.ActionRow({
            title: 'Alarm Time',
            subtitle: 'Set the hour and minute for the alarm'
        });
